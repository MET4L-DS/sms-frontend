...
export default function AccountPage() {
  ...
  useEffect(() => {
    const loadProfileData = async () => {
      try {
        ...
        try {
          const [deptData, batchData, progData] = await Promise.allSettled([
          ...
          if (batchData.status === "fulfilled") setBatches(batchData.value);
          if (progData.status === "fulfilled") setProgrammes(progData.value);
        } catch (error) {
        ...
        if (userProfile.user_type === "STUDENT") {
          try {
            const studentData = await ProfileService.getStudentProfile(token);
            ...
            studentProfileForm.reset({
              ...
              date_of_birth: studentData.date_of_birth
                ...
                : undefined,
              self_phone_number: studentData.self_phone_number || "",
              guardian_phone_number: studentData.guardian_phone_number || "",
              batch_id: studentData.batch_id,
            });

            // Load addresses for students
            const addressData = await ProfileService.getAddresses(token);
            setAddresses(addressData);
          } catch (error) {
            console.warn("Student profile not found, can be created");
          }
        } else if (userProfile.user_type === "FACULTY") {
          try {
            const facultyData = await ProfileService.getFacultyProfile(token);
            ...
            console.warn("Faculty profile not found, can be created");
          }
        }
      } catch (error) {
  ...
  const handleStudentProfileUpdate = async (data: StudentProfileFormData) => {
    ...
    try {
      ...
      try {
        const updatedStudentProfile = await ProfileService.getStudentProfile(
          token
        );
  ...
  const handleFacultyProfileUpdate = async (data: FacultyProfileFormData) => {
    ...
    try {
      ...
      try {
        const updatedFacultyProfile = await ProfileService.getFacultyProfile(
          token
        );
                  ...
                  <TabsContent value="student">
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>
                          Update your academic information and student details.
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                              ...
                              render={({ field }) => (
                                <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                                  ...
                                  <div className="space-y-1 leading-none">
                                    <FormLabel>Part-time Student</FormLabel>
                                    <p className="text-sm text-muted-foreground">
                                      Check if you are a part-time student
                                    </p>
                                  </div>
                                </FormItem>
                              )}
                    ...
                    <Card>
                      ...
                      <CardContent>
                        <Form {...facultyProfileForm}>
                          ...
                          >
                            <FormField
                              control={facultyProfileForm.control}
                              name="phone_number"
                              render={({ field }) => (
                                <FormItem>
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  ...
                                  <p className="text-sm text-muted-foreground">
                                    Describe your area of expertise and research
                                    interests.
                                  </p>
                                  <FormMessage />
                                </FormItem>
                            ...
                            <div className="flex justify-end">
                              <Button
                                type="submit"
                                disabled={isUpdatingFacultyProfile}
                              >
                    ...
                    <div className="space-y-6">
                      ...
                      <Card>
                        <CardHeader>
                          ...
                          <CardDescription>
                            Manage your current and permanent addresses.
                          </CardDescription>
                        </CardHeader>
                        <CardContent>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <CardHeader>
                          <div className="flex justify-between items-center">
                            <div>
                              ...
                              <CardDescription>
                                Add and manage your addresses. You can assign
                                them as current or permanent.
                              </CardDescription>
                            </div>
                            <Button
                              onClick={() => {
