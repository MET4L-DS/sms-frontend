...
export default function ProgrammesPage() {
	...
	const loadDegrees = async () => {
		try {
			...
			console.warn("Failed to load degrees:", errorMessage);
		}
	};
	...
	const handleCreate = async (e: React.FormEvent) => {
		...
		try {
			...
			const createData: CreateProgrammeRequest = {
				...
				minimum_duration_years: parseInt(
					formData.minimum_duration_years
				),
							...
							<div className="flex items-center justify-between">
								<div className="flex items-center">
									...
									<div>
										...
										<CardDescription>
											Academic programmes offered by your
											department
										</CardDescription>
									</div>
								</div>
												...
												<div className="grid gap-4 py-4">
													...
													<div className="grid grid-cols-4 items-center gap-4">
														...
														<Input
															...
															max="15"
															value={
																formData.maximum_duration_years
															}
															onChange={(e) =>
																setFormData({
																	...formData,
