		...
		<div className="space-y-6">
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Welcome back, {userProfile.full_name}. Here&apos;s
						what&apos;s happening in your system.
					</CardDescription>
				</CardHeader>
				<CardContent>
					<p className="text-sm text-muted-foreground">
						Use the sidebar to navigate to different administrative
						sections like Department Management, User
		...
		<div className="space-y-6">
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Welcome back, {userProfile.full_name}. Here&apos;s your
						department summary.
					</CardDescription>
				</CardHeader>
				<CardContent>
	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					Welcome back, {userProfile.full_name}. Manage students and
					batches from here.
				</CardDescription>
			</CardHeader>
			<CardContent>
				<p className="text-sm text-muted-foreground">
					Use the sidebar to navigate to Student Management and Batch
					Management sections.
				</p>
			</CardContent>
		</Card>
	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					Welcome back, {userProfile.full_name}. Access your academic
					tools here.
				</CardDescription>
			</CardHeader>
			<CardContent>
				<p className="text-sm text-muted-foreground">
					Use the sidebar to access Students and Programme
					information.
				</p>
			</CardContent>
		</Card>
	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					Welcome back, {userProfile.full_name}. View your academic
					information here.
				</CardDescription>
			</CardHeader>
			<CardContent>
				<div className="space-y-4">
					...
					<p className="text-sm text-muted-foreground">
						Use the sidebar to access your Profile and Academic
						Information.
					</p>
				</div>
			</CardContent>
				...
				<Card>
					...
					<CardContent>
						<p className="text-muted-foreground">
							Your user type is not recognized. Please contact
							support.
						</p>
					</CardContent>
				</Card>
