    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Update department information. If the HOD email doesn't exist in
            this department, a new user will be created and assigned as HOD.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Email address for the Head of Department. System will check
                    if user exists in this department, otherwise create new user
                    and assign as HOD.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
